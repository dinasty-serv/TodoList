...
class UserController extends AbstractController
{
     ...
     */
    public function new(Request $request, PasswordHasherFactoryInterface $encoder): Response
    {
        $user = new User();
     ...
     */
    public function edit(Request $request, User $user, PasswordHasherFactoryInterface $encoder): Response
    {
        $form = $this->createForm(UserType::class, $user);
        $form->handleRequest($request);
